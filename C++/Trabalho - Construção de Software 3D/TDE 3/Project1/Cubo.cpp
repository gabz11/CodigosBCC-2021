...
void Cubo::Desenha()
{
    ...
    glPushMatrix();
        ...
        //Cálculo do centro de cada face:
        // Face 1
        ...
        // Face 4
        float cf4x = (f4[0][0] + f4[1][0] + f4[2][0] + f4[3][0]) / 4;
        float cf4y = (f4[0][1] + f4[1][1] + f4[2][1] + f4[3][1]) / 4;
        float cf4z = (f4[0][2] + f4[1][2] + f4[2][2] + f4[3][2]) / 4;
