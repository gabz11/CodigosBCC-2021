...
TetraHedro::TetraHedro(int idC, float ppcx, float ppcy, float ppcz, float aa)
{
	...
	// Base como um tri�ngulo equil�tero com o centro na origem e altura "a"
...
void TetraHedro::Desenha()
{
	...
	// c�lculo do centro das faces
	// Face 1
	// centro da face
	float cf1x = (t1[0][0] + t1[1][0] + t1[2][0] ) / 3; //  m�dia dos componentes em x
	...
	glEnd();
	// Face 2
	float cf2x = (t2[0][0] + t2[1][0] + t2[2][0]) / 3; //  m�dia dos componentes em x
	...
	glEnd();
	// Face 3
	float cf3x = (t3[0][0] + t3[1][0] + t3[2][0]) / 3; //  m�dia dos componentes em x
	...
	glEnd();
	// Face 4
	float cf4x = (t4[0][0] + t4[1][0] + t4[2][0]) / 3; //  m�dia dos componentes em x
